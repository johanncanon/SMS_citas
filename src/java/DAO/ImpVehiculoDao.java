                        ...
                        + "("
                            + "('" + fechaInicio + "' = '" + fechaLlegada + "' and vehiculo.idVehiculo in(select ag.smsVehiculo.idVehiculo from SmsAgenda as ag) and "
                                + "("
                                    ...
                                    + "("
                                        + "(not exists (from SmsAgenda as ag where ag.smsVehiculo = vehiculo.idVehiculo and ((ag.agendaHoraInicio >= '" + horaInicio + "' and (ag.agendaHoraLlegada > '" + horaLlegada + "' or ag.agendaHoraLlegada < '" + horaLlegada + "')) or (ag.agendaHoraLlegada >= '" + horaInicio + "')))) and "
                                        + "("
                                            ...
                                            + "('" + espacioInicio + "' > all (select ag.agendaHoraLlegada from SmsAgenda as ag where ag.agendaHoraLlegada < '" + horaInicio + "' and ag.smsVehiculo = vehiculo.idVehiculo and ag.agendaFechaLlegada = '" + fechaInicio + "'))"
                                        + ")"
                                    + ")"
                                + ")"
                            + ")"
